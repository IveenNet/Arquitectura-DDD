...
namespace Pacagroup.Ecommerce.Application.UseCases.Customers
{
	public class CustomersApplication : ICustomersApplication
	{
		...
		public CustomersApplication(IUnitOfWork unitOfWork, IMapper mapper, ILogger<CustomersApplication> appLogger)
		{
		...
		public Response<bool> Update(CustomerDto customerDto)
		{
			...
			if (response.Data)
			{
				...
				_logger.LogInformation("Update OK");
			}
		...
		public Response<bool> Delete(string customerId)
		{
			...
			if (response.Data)
			{
				...
				_logger.LogInformation("Borrado OK");
			}
