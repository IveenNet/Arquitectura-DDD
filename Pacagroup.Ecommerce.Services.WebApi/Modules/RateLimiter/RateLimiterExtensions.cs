...
namespace Pacagroup.Ecommerce.Services.WebApi.Modules.RateLimiter
{
	public static class RateLimiterExtensions
	{
		...
		public static IServiceCollection AddRateLimiting(this IServiceCollection services, IConfiguration configuration)
		{
			...
			services.AddRateLimiter(configureOption =>
			{
				configureOption.AddFixedWindowLimiter(policyName: fixedWindowPolicy, fixedWindow =>
				{
				...
				configureOption.RejectionStatusCode = StatusCodes.Status429TooManyRequests;
			});
